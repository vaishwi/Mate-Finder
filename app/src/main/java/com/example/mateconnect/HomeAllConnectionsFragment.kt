...
class HomeAllConnectionsFragment : Fragment() {

    private var _binding: FragmentHomeAllConnectionsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHomeAllConnectionsBinding.inflate(inflater, container, false)
